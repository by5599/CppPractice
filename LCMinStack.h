#ifndef LC_MIN_STACK_H
#define LC_MIN_STACK_H
...
class MinStack {
    private:
        ...
        MyStack<int> stack; //real stack store the data
        MyStack<minData> minStack; //minimal number stack store the number
